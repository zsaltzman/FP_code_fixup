...
if strcmp(exp,'2019-06')
    ...
    %Real folders/files
    folder = 'C:\Users\User\Google Drive\2019-06 NBM-BLA + GACh FP\Doric\Processed' ;
    outputfolder = 'C:\Users\User\Google Drive\2019-06 NBM-BLA + GACh FP\Doric\Processed\2019-06 App MATLAB';
    outputfile = '2019-06 App MATLAB Output';
    medpcfile = 'C:\Users\User\Google Drive\2019-06 NBM-BLA + GACh FP\2019-06 MedPC Full';
    
    timestampfolder = 'C:\Users\User\Google Drive\2019-06 NBM-BLA + GACh FP\';
...
for row = 1:size(medraw,1)
    ...
    for variable=1:8
        ...
        %trim the actions after 19 min (1140 sec)
        meddata{1,variable}(1,meddata{1,variable}>1140) = NaN;
